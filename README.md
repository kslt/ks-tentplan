![GitHub License](https://img.shields.io/github/license/kslt/ks-tentplan)
![GitHub Stars](https://img.shields.io/github/stars/kslt/ks-tentplan)
![GitHub Forks](https://img.shields.io/github/forks/kslt/ks-tentplan)
<h1>✨ TentPlan ✨</h1>
A webapplication to plan your tents on a trip.<br>
THANKS TO:
A had a big help from Google Gemini in the making of this project.
...
2. Create a .env file with this info:
...
This means that if you integrate this code into a service that you offer to others, you must also provide the source code of your version to your users.<br> 
